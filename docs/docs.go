    ...
    "paths": {
        ...
        "/permissions/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "successfully returns a permission detail",
                        "schema": {
                            "$ref": "#/definitions/dto.Permission"
                        }
                    },
        ...
        "/permissions/{id}/status": {
            "patch": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdatePermissionStatus"
                        }
                    },
                    {
                        "type": "string",
                ...
                "responses": {
                    "200": {
                        "description": "successfully updates the permission's status",
                        "schema": {
                            "type": "boolean"
                        }
                    },
    ...
    "definitions": {
        ...
        "dto.Permission": {
            ...
            "properties": {
                ...
                "delete_or_update": {
                    "description": "DeletedAt is the time this permission was deleted.",
                    "type": "boolean"
                },
                "description": {
                    "description": "Description is the description of the permission being created",
                ...
                "tenant": {
                    "description": "Tenant is the scope the permissions is registred in.\nIt is set to null unless it's created by a tenant",
                    "type": "string"
                },
                "updated_at": {
        ...
        "dto.UpdatePermissionStatus": {
            "type": "object",
            "properties": {
                "status": {
                    "description": "Status is new status of the permission that is going to replace the old one",
                    "type": "string"
                }
            }
        },
