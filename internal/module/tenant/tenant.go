...
func (u *tenant) UpdateCorporateUserRoleStatus(ctx context.Context, param dto.UpdateUserRoleStatus, corporateID string,
	...
	if err = u.tenantPersistant.UpdateCorporateUserRoleStatus(ctx, param, roleId, userId, serviceID, corporateID); err != nil {
		return err
	}
