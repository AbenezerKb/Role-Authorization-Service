...
type Permission interface {
	...
	BulkCreatePermission(ctx context.Context, param []dto.CreatePermission) error
...
type User interface {
	...
	UpdateCorporateUserRoleStatus(ctx context.Context, param dto.UpdateUserRoleStatus, corporateID,
